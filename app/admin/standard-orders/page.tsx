...
const STANDARD_ORDERS: Order[] = [
  { id: '#ORD-001', customer: 'Alice Wang',   provider: '李师傅',   service: '家庭清洁', amount: '$150.00', status: '已完成', date: '2026-02-20' },
  { id: '#ORD-004', customer: 'David Chen',   provider: '刘阿姨',   service: '家政服务', amount: '$180.00', status: '已完成', date: '2026-02-22' },
  { id: '#ORD-006', customer: 'Frank Wu',     provider: '赵阿姨',   service: '物业维修', amount: '$140.00', status: '进行中', date: '2026-02-23' },
  { id: '#ORD-008', customer: 'Henry Guo',    provider: '周阿姨',   service: '宠物护理', amount: '$165.00', status: '已完成', date: '2026-02-24' },
];
...
export default function StandardOrdersPage() {
  ...
  const filtered = STANDARD_ORDERS.filter((o) => {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h1 className="text-3xl font-bold text-text-primary">标准服务订单</h1>
        <p className="text-text-secondary mt-1">查看并管理所有标准服务订单</p>
      </div>
