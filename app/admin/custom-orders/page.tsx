...
export default function CustomOrdersPage() {
  ...
  const filtered = CUSTOM_ORDERS.filter((o) => {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h1 className="text-3xl font-bold text-text-primary">定制服务订单</h1>
        <p className="text-text-secondary mt-1">查看并管理所有定制服务订单</p>
      </div>
