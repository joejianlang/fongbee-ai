  ...
  return (
    <div className="pb-6">
      <div className="sticky top-14 z-40 bg-white dark:bg-[#2d2d30] border-b border-border-primary px-4 py-3 flex items-center gap-3">
        ...
        <span className="font-semibold text-text-primary dark:text-white text-sm">关于我们</span>
      </div>
      ...
      <div className="px-4 md:px-0 mt-6 space-y-5">
        ...
        <div className="bg-white dark:bg-[#2d2d30] rounded-xl shadow-sm p-5">
          <h2 className="font-semibold text-text-primary dark:text-white mb-3">平台介绍</h2>
        ...
        <div className="bg-white dark:bg-[#2d2d30] rounded-xl shadow-sm overflow-hidden">
          <p className="text-xs text-text-muted font-medium px-4 pt-3 pb-1.5">联系我们</p>
          {[
            { icon: Mail,   label: '客服邮箱', value: 'support@shuweibuffet.ca' },
            { icon: MapPin, label: '公司地址', value: 'Guelph, Ontario, Canada' },
            { icon: Globe,  label: '官方网站', value: 'www.shuweibuffet.ca' },
        ...
        {/* 法律链接 */}
        <div className="bg-white dark:bg-[#2d2d30] rounded-xl shadow-sm overflow-hidden">
          <p className="text-xs text-text-muted font-medium px-4 pt-3 pb-1.5">法律与政策</p>
          {[
            { label: '服务条款' },
            { label: '隐私政策（CPPA 合规）' },
            { label: '退款政策' },
