      ...
      <div className="max-w-md mx-auto">
        <div className="bg-white rounded-xl shadow-lg p-8">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <input
                  type="text"
                  required
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#0d9488]/40 focus:border-transparent outline-none"
                  placeholder="李"
          ...
          <div className="mt-6 text-center text-sm text-gray-600">
            已有账户？{' '}
            <a href="/login" className="text-[#0d9488] hover:underline font-medium">
              登录
            </a>
          </div>
        </div>
